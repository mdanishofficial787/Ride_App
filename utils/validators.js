...
// module.exports = {
//     validateCNIC:  Validators.isValidCNIC,
//     validateVehicleType: (type) =>
//         Validators.isValidEnum(type, ['car', 'bike', 'rickshaw', 'van']),
//     validateCoordinates: (lat, lng) =>
//         Validators.isValidLatitude(lat) && Validators.isValidLongitude(lng),
...
// ✅ Returns {valid, lat, lng, message} — works for both boolean and object checks
...
const validateVehicleType = (type) => {
    return ['car', 'bike', 'rickshaw', 'van'].includes(type);
};
...
module.exports = {
    ...
    // ✅ backward compat aliases used in older code
    validateCNIC: isValidCNIC,
    Validators: {
        isValidEmail,
        isValidMobile,
        isValidCNIC,
